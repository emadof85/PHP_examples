<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/chosen/css/chosen.min.css">
<section class="section">
    <div class="section-header">
        <h1><i class="fas fa-cash-register"></i> <?php echo $page_title; ?></h1>
    ...
    <div class="section-body">
        <div class="row">
            ...
            <?php if(!$wc_connected) : ?>
                <div class="col-12">
                        <form action="<?php echo base_url('ecommerceexternal/connect'); ?>" method="POST">
                            <div class="card">
                                <div class="card-header"><h4 class="card-title"><i class="fas fa-info-circle"></i> <?php echo $this->lang->line("New WooCommerce Store"); ?></h4></div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for=""><i class="fas fa-file-signature"></i> <?php echo $this->lang->line("Store Name"); ?> </label>
                                                <input name="store_name" value="" class="form-control" type="text" required>
                                                <span class="red"></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for=""><i class="ion ion-key"></i> <?php echo $this->lang->line("Store Url"); ?> </label>
                                                <input name="store_url" value="" class="form-control" type="text" required>
                                                <span class="red"></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="currencyList"><i class="ion ion-cash"></i> <?php echo $this->lang->line("Store Currency"); ?> </label>
                                                <select data-placeholder="Please select your default store Currency..." name="store_currency" class="form-control chosen-select" id="currencyList">
                                ...
                                <div class="card-footer bg-whitesmoke">
                                    <button class="btn btn-primary btn-lg" id="save-btn" type="submit"><i class="fas fa-save"></i> <?php echo $this->lang->line("Connect"); ?></button>
                                    <button class="btn btn-secondary btn-lg float-right" onclick='goBack("ecommerceexternal")' type="button"><i class="fa fa-remove"></i>  Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
            <?php else : ?>
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            <h4><?php echo $this->lang->line("Products List"); ?></h4>
                            <p><?php echo $this->lang->line("List of your WooCommerce Store Products"); ?></p>
                            <a href="<?php echo base_url("ecommerceexternal/products"); ?>" class="card-cta"><?php echo $this->lang->line("List all products"); ?> <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            <h4><?php echo $this->lang->line("Categories List"); ?></h4>
                            <p><?php echo $this->lang->line("List of your WooCommerce Store Categories"); ?></p>
                            <a href="<?php echo base_url("ecommerceexternal/categories"); ?>" class="card-cta"><?php echo $this->lang->line("List all categories"); ?> <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            <h4><?php echo $this->lang->line("Settings"); ?></h4>
                            <p><?php echo $this->lang->line("Edit store settings and preferences"); ?></p>
                            <a href="<?php echo base_url("ecommerceexternal/settings"); ?>" class="card-cta"><?php echo $this->lang->line("Store settings"); ?> <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<script src="<?php echo base_url(); ?>assets/chosen/js/chosen.jquery.min.js" type="text/javascript" charset="utf-8"></script>
<script src="<?php echo base_url(); ?>assets/chosen/js/chosen.proto.min.js" type="text/javascript" charset="utf-8"></script>
<script>
